...
export const WorkTimeline = ({ data }: { data: ExperienceEntry[] }) => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-8 md:py-20 px-2 md:px-8 lg:px-10">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-2xl md:text-5xl mb-2 md:mb-6 text-black dark:text-white font-bold"
        >
        ...
        <motion.p
          ...
          className="text-neutral-700 dark:text-neutral-300 text-base md:text-xl max-w-3xl"
        >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-8 md:pb-20">
        {data.map((item, index) => (
          <motion.div
            key={index}
